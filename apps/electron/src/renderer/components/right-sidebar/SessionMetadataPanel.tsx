  ...
  if (!sessionId) {
    return (
      <div className="h-full flex flex-col">
        <PanelHeader title="会话信息" actions={closeButton} />
        <div className="flex-1 flex items-center justify-center text-muted-foreground p-4">
          <p className="text-sm text-center">未选择会话</p>
        </div>
      </div>
    )
  }
  ...
  if (!session) {
    return (
      <div className="h-full flex flex-col">
        <PanelHeader title="会话信息" actions={closeButton} />
        <div className="flex-1 flex items-center justify-center text-muted-foreground p-4">
          <p className="text-sm text-center">加载会话中...</p>
        </div>
      </div>
    )
  }
        ...
        <div>
          ...
          <div className="rounded-lg bg-foreground-2 has-[:focus]:bg-background shadow-minimal transition-colors">
            <Textarea
              ...
              placeholder={notesLoaded ? '添加备注...' : '加载中...'}
